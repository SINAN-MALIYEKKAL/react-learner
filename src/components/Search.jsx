...
export default function Search() {
  ...
  return (
    <>
      <div
        className="bg-black opacity-95 md:h-screen md:w-screen lg:h-screen lg:w-full fixed top-0 flex justify-center h-screen w-full z-[1000]"
        id="popUp"
      >
        ...
        <div id="cards">
          ...
          <div className="mt-8 grid grid-cols-2 md:grid-cols-4 xl:grid-cols-8 h-fit gap-4 p-5 py-10 z-[5000] absolute top-40 left-0">
            {filteredMovies.map((movie) => (
              <div
                key={movie.key}
                className="m-2 bg-[#181b22] rounded-lg shadow-lg h-[300px] w-full relative pr-3"
              >
